...
import PublicBookmarkClient from "@/components/shiori/PublicBookmarkClient";
import type { ItineraryItem, ShioriData } from "@/components/shiori-moc/types";
...
export default async function PublicBookmarkPage({
  ...
  return <PublicBookmarkClient data={shioriData} mapLinkUrl={mapLinkUrl} />;
}
